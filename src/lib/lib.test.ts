import { calculateHeating } from "./calculate-heating";
...
describe("Calculate Heating", () => {
  it("Water Heating from zero", () => {
    ...
    expect(calculateHeating(heater, material)).toBeCloseTo(0.0024, 4);
  });
  ...
  it("Water Heating from 10K", () => {
    ...
    expect(calculateHeating(heater, material)).toBeCloseTo(24.3541, 4);
  });
});
describe("Calculate Radiance Steel", () => {
  it("Steel radiate from boiling 773 K", () => {
    ...
    expect(calculateRadiance(1, material, 773, 1)).toBeCloseTo(738.3945, 4);
  });
});
...
//       newSubstrateMesh = calculateMesh({
//         mesh: substrateMesh,
//         contactMesh: coatingMesh,
//         time,
//         targetMaterial: substrateMaterial,
